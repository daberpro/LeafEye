#pragma once
#include "UpdateUserDialog.g.h"

namespace winrt::LeafEye::implementation
{
    struct UpdateUserDialog : UpdateUserDialogT<UpdateUserDialog>
    {
        UpdateUserDialog();
...
{
    struct UpdateUserDialog : UpdateUserDialogT<UpdateUserDialog, implementation::UpdateUserDialog>
    {
    };
}